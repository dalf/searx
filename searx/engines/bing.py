...
from searx.utils import match_language, gen_useragent, html_fromstring, eval_xpath
...
async def request(query, params):
    ...
    query = 'language:{} {}'.format(lang.split('-')[0].upper(), query.decode('utf-8')).encode('utf-8')
